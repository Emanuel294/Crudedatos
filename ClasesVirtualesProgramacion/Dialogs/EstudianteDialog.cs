    ...
    public partial class EstudianteDialog : baseDialog
    {
        ...
        protected override bool ValidarEntrada()
        {
            ...
            if (sexoComboBox.SelectedIndex < 0)
                return NotificacionDeValidacion("Por favor selecciona Femenino o Masculino para el sexo del estudiante", sexoComboBox);
            ...
            if (direccionTextBox.Text.Trim() == string.Empty)
                return NotificacionDeValidacion("Por favor escriba la dirrecion donde el estudiante vive", direccionTextBox);
